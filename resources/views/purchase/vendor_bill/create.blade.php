@extends('layouts.app')
@section('title', 'Create Vendor Bill')

@section('content')
<div class="card shadow">
    <div class="card-header">
        <h5 class="mb-0">Create Vendor Bill</h5>
    </div>
    
    <div class="card-body">
        <form action="{{ route('purchase.vendor-bill.store') }}" method="POST" id="vendorBillForm">
            @csrf
            ...
            <div class="d-flex justify-content-between">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> Save Vendor Bill
                </button>
