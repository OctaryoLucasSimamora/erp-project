...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('sales.quotation.index') }}" class="btn btn-secondary">
    ...
    <form action="{{ route('sales.quotation.update', $quotation->id) }}" method="POST" id="quotation-form">
        @csrf
        @method('PUT')
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" name="order_date" id="order_date" 
                                   ...
                                   value="{{ old('order_date', $quotation->order_date->format('Y-m-d')) }}" required>
                            @error('order_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" name="expiration_date" id="expiration_date" 
                                   ...
                                   value="{{ old('expiration_date', $quotation->expiration_date->format('Y-m-d')) }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="notes" id="notes" rows="2" 
                                      class="form-control @error('notes') is-invalid @enderror">{{ old('notes', $quotation->notes) }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
