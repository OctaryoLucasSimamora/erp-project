...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3>Edit Sales Order - {{ $salesOrder->order_number }}</h3>
    ...
    <form action="{{ route('sales.order.update', $salesOrder->id) }}" method="POST" id="sales-order-form">
        @csrf
        @method('PUT')
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" name="expiration_date" id="expiration_date" 
                                   ...
                                   value="{{ old('expiration_date', $salesOrder->expiration_date->format('Y-m-d')) }}" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" name="confirmation_date" id="confirmation_date" 
                                   ...
                                   value="{{ old('confirmation_date', $salesOrder->confirmation_date ? $salesOrder->confirmation_date->format('Y-m-d') : '') }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" name="commitment_date" id="commitment_date" 
                                   ...
                                   value="{{ old('commitment_date', $salesOrder->commitment_date ? $salesOrder->commitment_date->format('Y-m-d') : '') }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="pricelist" id="pricelist" 
                                   ...
                                   value="{{ old('pricelist', $salesOrder->pricelist) }}" placeholder="e.g., Standard Price">
                            @error('pricelist')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="warehouse" id="warehouse" 
                                   ...
                                   value="{{ old('warehouse', $salesOrder->warehouse) }}" placeholder="e.g., Main Warehouse">
                            @error('warehouse')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="incoterms" id="incoterms" 
                                   ...
                                   value="{{ old('incoterms', $salesOrder->incoterms) }}" placeholder="e.g., FOB, CIF, EXW">
                            @error('incoterms')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="payment_terms" id="payment_terms" rows="2" 
                                      class="form-control @error('payment_terms') is-invalid @enderror">{{ old('payment_terms', $salesOrder->payment_terms) }}</textarea>
                            @error('payment_terms')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="notes" id="notes" rows="2" 
                                      class="form-control @error('notes') is-invalid @enderror">{{ old('notes', $salesOrder->notes) }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="terms_and_conditions" id="terms_and_conditions" rows="3" 
                              class="form-control @error('terms_and_conditions') is-invalid @enderror">{{ old('terms_and_conditions', $salesOrder->terms_and_conditions) }}</textarea>
                    ...
                    <table class="table table-bordered" id="items-table">
                        ...
                        <tbody id="items-container">
                            @foreach($salesOrder->items as $item)
                                <tr class="item-row">
                                    <td>
                                        <select name="items[{{ $loop->index }}][product_id]" class="form-control form-control-sm product-select" required>
